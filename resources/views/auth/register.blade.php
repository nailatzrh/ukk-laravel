...
<body class="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center py-8 font-montserrat">
    <div class="container max-w-md mx-auto px-6">
        <div class="backdrop-blur-lg bg-gray-800/30 rounded-2xl shadow-2xl border border-gray-700/50 p-8 relative overflow-hidden">
            ...
            <h2 class="text-3xl font-bold text-gray-100 text-center mb-8">Form Register</h2>
            @if (session('success'))
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-6">
                @csrf
                <div class="space-y-2">
                    <label for="name" class="block text-gray-200 font-medium">Nama Lengkap</label>
                ...
                <div class="space-y-2">
                    <label for="password_confirmation" class="block text-gray-200 font-medium">Konfirmasi Password</label>
                ...
                <div class="text-center text-gray-400 mt-4">
                    Sudah punya akun? 
                    <a href="/login" class="text-gray-200 font-medium hover:text-indigo-400 underline transition duration-300">
                        Login
                    </a>
                </div>
            </form>
